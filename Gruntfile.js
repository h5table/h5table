module.exports = function (grunt) {
  ...
  var minifiedBanner = '/*! h5table <%= package.version %> | https://github.com/h5table/h5table/blob/master/LICENSE.md */';
  ...
  grunt.initConfig({
    ...
    concat: {
      ...
      'dist.full': {
        ...
        src: [
          'dist/js/h5table.full.js',
          'src/js/wrapper.end.js'
        ],
        dest: 'dist/js/h5table.full.js'
      }
    },
    ...
    uglify: {
      'dist': {
        src: 'dist/js/h5table.js',
        dest: 'dist/js/h5table.min.js',
        options: {
          banner: minifiedBanner
        }
      },
      'dist.full': {
        src: 'dist/js/h5table.full.js',
        dest: 'dist/js/h5table.full.min.js',
        options: {
          banner: minifiedBanner
        }
      }
    ...
    'saucelabs-qunit': {
      all: {
        options: {
          ...
          tags: ['tests', 'qunit'],
          urls: testUrls,
          testname: 'QUnit test for h5table',
          browsers: [
            {
    ...
    'gh-pages': {
      options: {
        ...
        push: true,
        repo: 'git@github.com:h5table/h5table.github.io.git'
      },
      src: '**'
    },
